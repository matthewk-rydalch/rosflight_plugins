...
#include "rosflight_plugins/three_d_move.h"

namespace rosflight_plugins
{

  threeDPlugin::threeDPlugin() : ModelPlugin() {}

  threeDPlugin::~threeDPlugin() {}

  // Load the controller
  void threeDPlugin::Load(gazebo::physics::ModelPtr _model, sdf::ElementPtr _sdf)
  {
